...
public class pdfTest {
    ...
    public static void main(String[] args) {
        List<fundClass> funds = new ArrayList<fundClass>();
        project project = new project();

        project.setTitle("This is a Test Title");
        ...
        project.setCategories("cat2");
        project.setCategories("cat3");
        project.setProjectPurpose("this is an example purpose");

        project.setProjectOwner("Lucas Mark Rassmussen");
        project.setProjectBudget(420690);
        ...
        PDFGen.GeneratePDF(project, funds);
